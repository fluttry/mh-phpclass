...
<body>
    ...
    <header class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-1 bg-white border-bottom shadow-sm">
        ...
        <a class="btn btn-outline-primary" href="https://m.me/madhu sah">fb Chat</a>
    </header>
    <div class="masthead text-center text-white purple p-4">
        <div class="masthead-content">
            <div class="container">
                <h1 class="masthead-heading mb-0">Hello there !</h1>
                <h2 class="masthead-subheading mb-0">I am madhu sah</h2>
                <a href="https://github.com/mandhu" class="btn btn-primary btn-xl rounded-pill mt-5">My GitHub Profile</a>
            </div>
        </div>
