<?php
$username = "madhu sah";
$fblink ="https://www.facebook.com/madhu.sha.37669/";
...
<body>
    ...
    <section>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="p-5">
                        <img class="img-fluid rounded-circle" src="img/2.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="p-5">
    ...
    <section>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="p-5">
                        <img class="img-fluid rounded-circle" src="img/3.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6 order-lg-1">
                    <div class="p-5">
    ...
    <footer class="align-items-center p-3 px-md-4 mt-3 bg-white border-top shadow-sm">
        ...
        <p>&copy; <?php echo $username; ?> &middot; <a href="/project.html">Project</a> &middot; <a
